          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-md mx-auto">
              ...
              <div className="text-center mb-8">
                <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">{"Welcome Back"}</h1>
                <p className="text-muted-foreground">{"Login to access your loan dashboard and applications"}</p>
              </div>
              ...
              <Card className="shadow-2xl border-border/50">
                <CardHeader className="text-center pb-6">
                  ...
                  <CardDescription className="text-base">{"Enter your WhatsApp number to receive OTP"}</CardDescription>
                </CardHeader>
