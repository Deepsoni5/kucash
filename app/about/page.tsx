  ...
  return (
    <>
      ...
      <main className="pt-16 md:pt-20">
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground text-balance">
                About{" "}
                <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent italic pr-4">
                  KuCash
                </span>
              </h1>
              <p className="text-xl sm:text-2xl text-muted-foreground font-medium leading-relaxed text-pretty">
                15 Years of Finance. 5,000+ Stories.{" "}
                <br className="hidden sm:block" />
                <span className="text-foreground font-bold">
                  One Mission -&gt; To Fix Borrowing in India.
                </span>
              </p>
            </div>
          </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                  <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                    <p className="indent-8 italic text-foreground font-medium border-l-4 border-primary pl-6 py-2 bg-primary/5 rounded-r-2xl">
                      KuCash wasn’t built in a boardroom by coders who have
                      never taken a loan. It was built on the ground, witnessing
                      the real struggles of Indian borrowers for over 15 years.
                    </p>
                    <p>
                      Before we wrote a single line of code, we served{" "}
                      <span className="text-foreground font-bold underline decoration-primary/30 decoration-4">
                        5,000+ customers offline
                      </span>
                      . We sat across the table from small business owners who
                      were rejected because of a single missing document.
                    </p>
                    <p>
                      We saw the anxiety in families waiting weeks for a "loan
                      approval" that never came. We saw the frustration of
                      people running from bank to bank, only to face hidden
                      charges and confusing terms.
                    </p>
                  </div>

                  <div className="space-y-6 text-lg text-muted-foreground leading-relaxed pt-2">
                    <p>
                      We realized that the lending system wasn&apos;t broken; it
                      was just{" "}
                      <span className="text-primary font-bold italic">
                        disconnected
                      </span>
                      . Good borrowers couldn&apos;t find the right lenders.
                    </p>
                    <p className="text-foreground font-medium bg-secondary/30 p-8 rounded-3xl border border-border/50 shadow-inner">
                      So, we built KuCash. We combined our deep financial
                      expertise with the power of technology to create a Loan
                      Service Provider (LSP) that removes the &quot;Run&quot;
                      from &quot;Bank Run.&quot;
                    </p>
                    <p>
                      Today, we don&apos;t just find you a loan; we match you
                      with the right partner from our network of{" "}
                      <span className="text-primary font-bold">
                        100+ banks and NBFCs
                      </span>
                      , ensuring speed, dignity, and transparency.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* Leadership Team */}
        <section className="py-20 lg:py-32 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6">
                Meet Our{" "}
              ...
              <p className="text-lg text-muted-foreground">
                The visionaries behind KuCash's mission to transform lending in
                India
              </p>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
                      <div className="relative">
                        <div className="w-32 h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-lg group-hover:border-primary/40 transition-colors">
                          <Image
                            src="/pf2.jpeg"
                            alt="Balakrishna Cherukuri - Founder"
                            width={128}
                            height={128}
                    ...
                    <div className="relative mb-6">
                      ...
                      <blockquote className="text-lg text-foreground font-medium italic leading-relaxed pl-8 pr-4">
                        Backed with 15+ years of hands-on entrepreneurial and
                        Finance experience, he has built and operated multiple
                        ventures across foodtech, HR tech, staffing, and
                    ...
                    <div className="p-6 rounded-2xl bg-muted/50 dark:bg-muted/20 border border-border/50">
                      <p className="text-muted-foreground leading-relaxed">
                        Known for his clarity, sharp decision-making, and
                        team-building abilities, he drives KuCash with a clear
                        purpose — to create a transparent global ecosystem where
                        trust becomes the core of lending.
                      </p>
                    </div>

                    {/* Experience Badge */}
                    <div className="flex items-center gap-2 mt-6 text-sm text-primary font-semibold">
              ...
              <div className="relative p-10 lg:p-14 rounded-[3rem] bg-card border border-border shadow-2xl overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <h3 className="text-3xl lg:text-4xl font-black text-foreground leading-tight italic">
                    &quot;To build an India where accessing credit is as
                    dignified and simple as spending your own money—free from
                    harassment, confusion, and fear.&quot;
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    We envision a financial ecosystem where a borrower never has
                    to beg for a loan. By leveraging the{" "}
                    <span className="text-foreground font-semibold">
                      Account Aggregator (AA) framework
                    </span>{" "}
                    and our partnerships with giants like{" "}
                    <span className="text-foreground font-semibold">Oxyzo</span>{" "}
                    and{" "}
                    <span className="text-foreground font-semibold">
                      V2s Fin Assist
                    </span>
                    , we aim to make credit invisible, instant, and inclusive
                    for every Indian.
                  </p>
                </div>
              </div>
              ...
              <div className="relative p-10 lg:p-14 rounded-[3rem] bg-primary text-primary-foreground shadow-2xl overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="inline-flex items-center gap-2 text-primary-foreground font-bold uppercase tracking-widest text-sm opacity-80">
                    <span className="w-10 h-[2px] bg-primary-foreground" /> Our
                    Mission
                  </div>
                  <h3 className="text-xl lg:text-2xl font-bold leading-relaxed">
                    &quot;To be India’s most transparent Loan Service Provider
                    (LSP) by bridging the gap between 100+ Regulated Lenders and
                    millions of borrowers through a &apos;Zero-Hassle,
                    Zero-Spam&apos; digital architecture.&quot;
                  </h3>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
                Core Values{" "}
                <span className="text-primary">(The KuCash Promise)</span>
              </h2>
              <p className="text-lg text-muted-foreground">
                These aren&apos;t just words on a wall; they are the rules we
                lived by for 15 years and continue to uphold today.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-8 lg:gap-12">
              {[
                ...
                return (
                  <div
                    key={index}
                    className="group relative p-8 lg:p-10 rounded-3xl bg-card border border-border/50 hover:border-primary/50 hover:shadow-2xl transition-all duration-500 overflow-hidden"
                  >
                    <div className="flex flex-col gap-6">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold mb-4 text-foreground group-hover:text-primary transition-colors italic">
                          {value.title}
                        </h3>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 text-center text-primary-foreground">
              <div className="space-y-2">
                ...
                <div className="text-white/80 font-semibold uppercase tracking-widest text-sm">
                  Loans Disbursed
                </div>
              </div>
              <div className="space-y-2">
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              <h2 className="text-4xl lg:text-6xl font-extrabold text-foreground text-balance">
                ...
                <span className="text-primary italic">KuCash Difference?</span>
              </h2>
              ...
              <Link href="/#apply">
                <Button
                  size="lg"
                  className="rounded-full bg-gradient-to-r from-primary to-accent text-xl px-12 py-8 hover:scale-105 transition-transform shadow-xl"
                >
                  Get Your Loan Now
                </Button>
              </Link>
