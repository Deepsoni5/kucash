...
export function getEmailVerificationTemplate(
  ...
  return {
    subject: "Verify Your KuCash Account",
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        ...
        <h1 class="title">Welcome to KuCash!</h1>
        
        <div class="content">
            <p>Hello ${name},</p>
            
            <p>Thank you for signing up with KuCash! We're excited to have you join our community of smart borrowers and financial partners.</p>
            
            <p>To complete your account setup and start accessing our services, please verify your email address by clicking the button below:</p>
            ...
            <div class="success-box">
                ...
                <ul style="margin: 8px 0; padding-left: 20px;">
                    <li>Apply for instant loans</li>
                    <li>Access your personalized dashboard</li>
                    <li>Track your loan applications</li>
                    <li>Connect with our financial experts</li>
                </ul>
            </div>
...
Thank you for signing up with KuCash! We're excited to have you join our community of smart borrowers and financial partners.

To complete your account setup and start accessing our services, please verify your email address using the link below:
